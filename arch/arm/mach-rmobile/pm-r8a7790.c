...
#define DBGCPUPREN		BIT(19)	/* CPU Peripheral Reset Request Enable */
...
int __secure r8a7790_apmu_power_off_poll(int cpu)
{
	int cluster = r8a7790_cluster_id(cpu);
	u32 apmu_base;
	int i;
...
static void apmu_setup_debug_mode(int cpu)
{
	 ...
	 * CPU cores in debug mode. Without taking care of, they may fail to resume
	 * from the power shutoff state.
	 */
